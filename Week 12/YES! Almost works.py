...
def addExposure():
    ...
    f = int(input("Please enter risk level,Whole number only (example 1,2,3,etc)"))
    NewItemExposure = [e,f]
...
def addStock():
    ...
    addExposure()
    print ()
#main function, allows for two stock keys and names to be created.Displays up to date Names, Prices and Exposure. Also, provides a menu with options to Add stock, get a stock recommendation or exit.
def main():
    print("Function main")
    print()
...
#GetSale funtion provides best stock option by perfoming rather basic math.
def GetSale():
